...
import '/chat_flow/chat_thread_update/chat_thread_update_widget.dart';
              ...
              stream: queryChatMessagesRecord(
                ...
                limit: 200,
                  ...
                  if (_model.listViewPreviousSnapshot != null &&
                    ...
                    () async {
                      logFirebaseEvent(
                          'CHAT_THREAD_COMPONENT_ListView_hsx1we6y_');
                    ...
                    return Container(
                      ...
                      child: wrapWithModel(
                        ...
                        child: ChatThreadUpdateWidget(
                          key: Key(
                            'Keyquc_${listViewChatMessagesRecord.reference.id}',
                          ),
                                ...
                                child: SizedBox(
                                  ...
                                  child: TextFormField(
                                    ...
                                    onFieldSubmitted: (_) async {
                                      logFirebaseEvent(
                                          'CHAT_THREAD_COMPONENT_TextField_pzkhm3r1');
                                      logFirebaseEvent(
