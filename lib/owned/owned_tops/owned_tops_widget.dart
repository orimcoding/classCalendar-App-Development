...
import 'owned_tops_model.dart';
export 'owned_tops_model.dart';
...
class _OwnedTopsWidgetState extends State<OwnedTopsWidget> {
  late OwnedTopsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => OwnedTopsModel());

    logFirebaseEvent('screen_view', parameters: {'screen_name': 'OwnedTops'});
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          leading: InkWell(
            ...
            onTap: () async {
              logFirebaseEvent('OWNED_TOPS_PAGE_Icon_qj9ysxjn_ON_TAP');
