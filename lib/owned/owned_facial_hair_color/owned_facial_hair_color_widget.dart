...
class _OwnedFacialHairColorWidgetState
    extends State<OwnedFacialHairColorWidget> {
                    ...
                    builder: (context) => Builder(
                      builder: (context) {
                        ...
                        return ListView.builder(
                          ...
                          itemBuilder: (context, facialHairColorOwnIndex) {
                            final facialHairColorOwnItem =
                                facialHairColorOwn[facialHairColorOwnIndex];
                            return Padding(
