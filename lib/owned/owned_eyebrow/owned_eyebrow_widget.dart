                ...
                child: Align(
                  ...
                  child: AuthUserStreamWidget(
                    builder: (context) => Builder(
                      builder: (context) {
                        final eyebrowOwn =
                            (currentUserDocument?.ownedEyebrows.toList() ?? [])
                                .toList();
                        ...
                        return ListView.builder(
                          ...
                          itemBuilder: (context, eyebrowOwnIndex) {
                            final eyebrowOwnItem = eyebrowOwn[eyebrowOwnIndex];
                            return Padding(
