                ...
                child: Align(
                  ...
                  child: AuthUserStreamWidget(
                    builder: (context) => Builder(
                      builder: (context) {
                        final clothesColorShop =
                            (currentUserDocument?.shopColorFabric.toList() ??
                                    [])
                                .toList();
                              ...
                              child: InkWell(
                                ...
                                onTap: () async {
                                  ...
                                  if (valueOrDefault(
                                      ...
                                      valueOrDefault<int>(
                                        () {
                                          if ((clothesColorShopItem == 'Blue1') ||
                                              (clothesColorShopItem ==
                                                  'Gray1') ||
                                              (clothesColorShopItem ==
                                                  'Gray2')) {
                                            return 5;
                                          } else if ((clothesColorShopItem == 'Blue2') ||
                                              (clothesColorShopItem ==
                                                  'Blue3') ||
                                              (clothesColorShopItem ==
                                                  'Heather') ||
                                      ...
                                      children: [
                                        FlutterFlowWebView(
                                          content: valueOrDefault<String>(
                                            'https://avataaars.io/?avatarStyle=Circle&clotheColor=$clothesColorShopItem',
                                                  ...
                                                  if ((clothesColorShopItem == 'Blue1') ||
                                                    ...
                                                    return 5;
                                                      ...
                                                      (clothesColorShopItem ==
                                                          'Red')) {
                                                    return 10;
                                                  } else if ((clothesColorShopItem == 'PastelBlue') ||
                                                      (clothesColorShopItem ==
                                                          'PastelGreen') ||
                                                      (clothesColorShopItem ==
                                                          'PastelOrange') ||
