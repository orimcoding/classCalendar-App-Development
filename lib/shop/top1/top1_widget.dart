...
import 'top1_model.dart';
export 'top1_model.dart';

class Top1Widget extends StatefulWidget {
  const Top1Widget({super.key});

  @override
  State<Top1Widget> createState() => _Top1WidgetState();
}

class _Top1WidgetState extends State<Top1Widget> with TickerProviderStateMixin {
  late Top1Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Top1Model());
                        ...
                        child: AuthUserStreamWidget(
                          builder: (context) => FlutterFlowDropDown<String>(
                            ...
                            onChanged: (val) async {
                              ...
                              FFAppState().selectedTop = _model.dropDownValue!;
                              setState(() {});
                            },
                            width: 142.0,
                            height: 56.0,
                      ...
                      onPressed: () async {
                        if (_model.dropDownValue == null ||
                          ...
                          if (valueOrDefault(currentUserDocument?.coins, 0) >=
                              valueOrDefault<int>(
                                () {
                                  if ((_model.dropDownValue == 'Eyepatch') ||
                                      (_model.dropDownValue == 'WinterHat2') ||
                                      (_model.dropDownValue == 'WinterHat3') ||
                                      (_model.dropDownValue == 'WinterHat4')) {
                                    return 10;
                                  } else if ((_model.dropDownValue ==
                                          'LongHairDreads') ||
                                      (_model.dropDownValue ==
                                          'LongHairFrida') ||
                                      (_model.dropDownValue == 'LongHairFro') ||
                                      (_model.dropDownValue ==
                                          'LongHairFroBand') ||
                                      (_model.dropDownValue ==
                                          'LongHairNotTooLong') ||
