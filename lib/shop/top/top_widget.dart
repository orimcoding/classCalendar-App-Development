...
class _TopWidgetState extends State<TopWidget> with TickerProviderStateMixin {
              ...
              child: Column(
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: FFButtonWidget(
                      onPressed: () async {
                        context.pushNamed('hairColor');
                      },
                      text: 'Shop Hair Color',
                      options: FFButtonOptions(
                        width: 350.0,
                        height: 125.0,
                        padding: const EdgeInsetsDirectional.fromSTEB(
