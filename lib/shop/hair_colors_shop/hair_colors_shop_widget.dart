...
class HairColorsShopWidget extends StatefulWidget {
  const HairColorsShopWidget({super.key});

  static String routeName = 'HairColorsShop';
  static String routePath = '/shopHairColorsCopy';
...
class _HairColorsShopWidgetState extends State<HairColorsShopWidget>
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => HairColorsShopModel());
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          leading: InkWell(
            ...
            onTap: () async {
              logFirebaseEvent('HAIR_COLORS_SHOP_Icon_bdw59n6w_ON_TAP');
                                        ...
                                        child: Padding(
                                          ...
                                          child: Row(
                                            ...
                                            children: [
                                              FlutterFlowWebView(
                                                content:
                                                    'https://api.dicebear.com/9.x/avataaars/svg?${valueOrDefault(currentUserDocument?.selectedAccessories, '') == '' ? 'accessoriesProbability=0' : 'accessoriesProbability=100&accessories=${valueOrDefault(currentUserDocument?.selectedAccessories, '')}'}&clothesColor=${valueOrDefault(currentUserDocument?.selectedColorFabric, '')}&clothing=${valueOrDefault(currentUserDocument?.selectedClothes, '')}&eyebrows=${valueOrDefault(currentUserDocument?.selectedEyebrows, '')}&eyes=${valueOrDefault(currentUserDocument?.selectedEyes, '')}&facialHair=${valueOrDefault(currentUserDocument?.selectedFacialHairs, '')}&facialHairColor=${valueOrDefault(currentUserDocument?.selectedFacialHairColors, '')}&facialHairProbability=${valueOrDefault(currentUserDocument?.selectedFacialHairs, '') == '' ? '0' : '100'}&hairColor=${hairColorsShopItem}&hatColor=${valueOrDefault(currentUserDocument?.selectedHatColors, '')}&mouth=${valueOrDefault(currentUserDocument?.selectedMouth, '')}&skinColor=${valueOrDefault(currentUserDocument?.selectedSkin, '')}&top=bigHair&topProbability=100',
                                                bypass: false,
                                                width: 75.0,
                                                height: 75.0,
