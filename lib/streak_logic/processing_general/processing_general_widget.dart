...
import 'processing_general_model.dart';
export 'processing_general_model.dart';
...
class ProcessingGeneralWidget extends StatefulWidget {
  ...
  State<ProcessingGeneralWidget> createState() =>
      _ProcessingGeneralWidgetState();
}

class _ProcessingGeneralWidgetState extends State<ProcessingGeneralWidget> {
  late ProcessingGeneralModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ProcessingGeneralModel());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'processingGeneral'});
    // On page load action.
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      logFirebaseEvent('PROCESSING_GENERAL_processingGeneral_ON_');
      logFirebaseEvent('processingGeneral_wait__delay');
      await Future.delayed(const Duration(milliseconds: 10));
      logFirebaseEvent('processingGeneral_timer');
            ...
            children: [
              Opacity(
                ...
                child: FlutterFlowTimer(
                  ...
                  onEnded: () async {
                    logFirebaseEvent(
                        'PROCESSING_GENERAL_Timer_n18jzmnm_ON_TIM');
